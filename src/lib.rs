...
pub fn get_file_contents(name: &Path) -> Result<String, Error> {
...
impl Executor {
    ...
    /// Output log
    pub fn log_print(&mut self, msg: String) {
    ...
    pub fn show_variables(&mut self) {
    ...
    pub fn show_stack(&mut self) -> String {
        format!(
            "Stack〔 {} 〕",
            self.stack
                .iter()
    ...
    pub fn analyze_syntax(&mut self, code: String) -> Vec<String> {
    ...
    pub fn evaluate_program(&mut self, code: String) {
